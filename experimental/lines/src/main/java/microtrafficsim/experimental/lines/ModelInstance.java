...
public class ModelInstance {
    ...
    public ModelInstance(Model base, Vec3f position, float scale, Color color, int polygonMode, float linewidth,
                         int cap, int join, boolean blend)
    {
        this.base = base;
    ...
    public void display(RenderContext context, Uniforms uniforms) {

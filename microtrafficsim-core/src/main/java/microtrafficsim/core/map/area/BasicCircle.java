 ...
 */
public class BasicCircle implements Area {
     ...
     * This call is equivalent to {@link BasicCircle#BasicCircle(Coordinate, Coordinate, DistanceCalculator)
     ...
     */
    public BasicCircle(Coordinate center, Coordinate onBorder) {
     ...
     * This call is equivalent to {@link BasicCircle#BasicCircle(Coordinate, double, DistanceCalculator)
     ...
     */
    public BasicCircle(Coordinate center, Coordinate onBorder, DistanceCalculator distcalc) {
     ...
     */
    public BasicCircle(Coordinate center, double radius) {
     ...
     * @param distcalc the method used for distance calculation.
     */
    public BasicCircle(Coordinate center, double radius, DistanceCalculator distcalc) {
        this.center   = center;
        this.radius   = radius;

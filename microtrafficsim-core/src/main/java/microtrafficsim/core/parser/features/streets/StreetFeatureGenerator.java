package microtrafficsim.core.parser.features.streets;
...
import microtrafficsim.core.parser.features.streetgraph.StreetGraphWayComponent;
...
/**
 * Feature generator for street-based {@link MapFeatureDefinition}s.
 *

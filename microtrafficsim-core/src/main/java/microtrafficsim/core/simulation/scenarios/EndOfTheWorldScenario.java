...
public abstract class EndOfTheWorldScenario extends AbstractStartEndScenario {
     ...
     * @param graph          reetgraph used for this scenarios.
        ...
        if (isBottom) {
            if (isLeft) {
                ...
                double latDistance = HaversineDistanceCalculator.getDistance(
                        startCoord, new Coordinate(bottomEnd.minlat, startCoord.lon));
                double lonDistance = HaversineDistanceCalculator.getDistance(
                        startCoord, new Coordinate(startCoord.lat, leftEnd.minlon));
                ...
                double latDistance = HaversineDistanceCalculator.getDistance(
                        startCoord, new Coordinate(bottomEnd.minlat, startCoord.lon));
                double lonDistance = HaversineDistanceCalculator.getDistance(
                        startCoord, new Coordinate(startCoord.lat, rightEnd.maxlon));
            ...
            if (isLeft) {
                // top left
                double latDistance = HaversineDistanceCalculator.getDistance(
                        startCoord, new Coordinate(topEnd.maxlat, startCoord.lon));
                double lonDistance = HaversineDistanceCalculator.getDistance(
                        startCoord, new Coordinate(startCoord.lat, leftEnd.minlon));

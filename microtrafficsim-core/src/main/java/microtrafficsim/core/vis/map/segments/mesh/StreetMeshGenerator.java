...
public class StreetMeshGenerator implements FeatureMeshGenerator {
    ...
    private void generateAdjacencyMesh(RenderContext context, Feature<? extends Street> feature,
    ...
    private void generateStandardMesh(RenderContext context, Feature<? extends Street> feature,
                                      ArrayList<Vertex> vertices, ArrayList<ArrayList<Integer>> indices) {
        int restartIndex = context.PrimitiveRestart.getIndex();

...
public class ScenarioAreaOverlay implements Overlay {
    private static final Logger logger = LoggerFactory.getLogger(ScenarioAreaOverlay.class);
    ...
    public void display(RenderContext context, MapBuffer map) {
        ...
        context.BlendMode.setFactors(
                gl, GL3.GL_SRC_ALPHA, GL3.GL_ONE_MINUS_SRC_ALPHA, GL3.GL_ONE, GL3.GL_ONE_MINUS_SRC_ALPHA);

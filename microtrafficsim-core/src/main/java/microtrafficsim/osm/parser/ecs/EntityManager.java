...
public abstract class EntityManager<EntityT extends Entity, SourceT> implements EntityFactory<EntityT, SourceT> {
    ...
    public <T extends Component> ComponentFactory<T, SourceT> putInitializer(Class<T> type,
                                                                             ComponentFactory<T, SourceT> factory) {
     ...
     */
    protected void initializeComponents(Set<Class<? extends Component>> components, EntityT entity, SourceT source,
        ...
        for (Class<? extends Component> type : components) {
            ...
            if (component != null) entity.getAll().put(component.getType(), component);
        }
    }
}

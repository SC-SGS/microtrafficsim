...
public class RestrictionRelation extends RelationBase {
    ...
    public RestrictionRelation(long id, Restriction restriction, List<Long> from, List<Long> to, List<Long> via,
                               Primitive.Type viaType) {
    ...
    public RestrictionRelation clone() {
        return new RestrictionRelation(this.id, this.restriction, new ArrayList<>(this.from), new ArrayList<>(this.to),
                                       new ArrayList<>(this.via), this.viaType);
    }
    ...
    public enum Restriction {
        ...
        public boolean isNoType() {
            return this == NO_RIGHT_TURN || this == NO_LEFT_TURN || this == NO_U_TURN || this == NO_STRAIGHT_ON
                    || this == NO_ENTRY || this == NO_EXIT;
        }
        ...
        public boolean isOnlyType() {
            return this == ONLY_RIGHT_TURN || this == ONLY_LEFT_TURN || this == Restriction.ONLY_STRAIGHT_ON;
        }
    }
}

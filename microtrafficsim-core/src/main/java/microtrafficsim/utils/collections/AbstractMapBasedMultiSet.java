...
public class AbstractMapBasedMultiSet<E> implements MultiSet<E> {
    ...
    public boolean remove(Object obj) {
        ...
        count.count--;
        if (count.count <= 0) { map.remove(obj); }
    ...
    public boolean equals(Object obj) {
        return (obj instanceof AbstractMapBasedMultiSet<?>) &&((AbstractMapBasedMultiSet<?>) obj).map.equals(this.map);
    }
    ...
    protected static class Count {
        ...
        public boolean equals(Object other) {
            return (other instanceof Count) && ((Count) other).count == this.count;
        }
    }

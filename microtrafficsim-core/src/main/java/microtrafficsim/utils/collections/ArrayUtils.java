...
public class ArrayUtils {
    ...
    public static int[] toArray(List<Integer> from, int[] to) {
        if (to == null || to.length < from.size()) { to = new int[from.size()]; }
    ...
    public static long[] toArray(List<Long> from, long[] to) {
        if (to == null || to.length < from.size()) { to = new long[from.size()]; }
    ...
    public static boolean reverseEquals(int[] a, int[] b) {
        ...
        for (int i = 0; i < a.length; i++)
            if (a[a.length - 1 - i] != b[i]) return false;
    ...
    public static class LongestCommonSubstring {
        ...
        private LongestCommonSubstring(int startA, int startB, int length) {
            this.startA = startA;
            this.startB = startB;
            this.length = length;
        }

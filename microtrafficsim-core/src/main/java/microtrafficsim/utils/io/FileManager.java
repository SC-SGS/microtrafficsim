...
public class FileManager {
    private final String PATH_TO_DATA_FILES;
    ...
    public FileManager(String PATH_TO_DATA_FILES) {
        ...
        // this.ABSOLUTE_PATH_TO_DATA_FILES = System.getProperty("user.dir")
     ...
     *                  be overwritten
     */
    public void writeDataToFile(String fileName, String data, boolean overwrite) {
        ...
        try {
            PrintWriter outputStream = new PrintWriter(new FileOutputStream(
                    PATH_TO_DATA_FILES + System.getProperty("file.separator") + fileName, !overwrite));

...
public class TestLeftmostIndex {
	...
	// String s1, s2, d, e;
	byte origin_s1, destination_s1, origin_s2, destination_s2, origin_d, destination_d, origin_e, destination_e,
	...
	public void testMethod() {
		...
		assertEquals(IndicesCalculator.NO_MATCH, IndicesCalculator.leftmostIndexInMatching(origin_s1, destination_s1,
				origin_d, destination_d, indicesPerNode));
		assertEquals(IndicesCalculator.NO_MATCH, IndicesCalculator.leftmostIndexInMatching(origin_d, destination_d,
				origin_s1, destination_s1, indicesPerNode));

...
public class UnitTestDijkstraExample {
	private final Logger logger = LoggerFactory.getLogger(UnitTestDijkstraExample.class);

	private LinkedList<DirectedEdge> shortestPath;
	private static SimulationConfig config;

	Queue<? extends IDijkstrableEdge> correctShortestPath;
	private String graphBefore, graphAfter;
	...
	public void setup() {
		...
		shortestPath = new LinkedList<DirectedEdge>();
	}
	...
	public void multipleCorrectPathsPossible() {
		...
		LinkedList<DirectedEdge> sP2 = new LinkedList<DirectedEdge>();
		sP2.addLast(gd);
		sP2.addLast(de);
		sP2.addLast(ea);
		sP2.addLast(ab);

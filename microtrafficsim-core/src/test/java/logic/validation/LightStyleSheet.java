...
class LightStyleSheet implements StyleSheet {
...

    {
        ...
        // feature predicates
        Predicate<Way> prMotorway     = new MinorStreetBasePredicate("motorway");
        Predicate<Way> prMotorwayLink = new MinorStreetBasePredicate("motorway_link");
        ...
        features.add(genStreetFeatureDef("streets:motorway_link", generator, prMotorwayLink));
        ...
        Style sMotorwayLinkOutline   = genStyle(streets, colors[0], 40.f, SCALE_MAXLEVEL);
        ...
        Style sMotorwayLinkInline    = genStyle(streets, Color.fromRGB(0xFDFDFD), 30.f, SCALE_MAXLEVEL);
        ...
        Style sMotorwayLinkOutlineL  = genStyle(streets, colors[0], 60.f, SCALE_MAXLEVEL);
        ...
        Style sMotorwayLinkOutlineXL = genStyle(streets, colors[0], 75.f, SCALE_MAXLEVEL);
        ...
        layers.add(genLayer("streets:motorway_link:outline",    index++, 16, 19, "streets:motorway_link", sMotorwayLinkOutline));
        ...
        layers.add(genLayer("streets:motorway_link:inline",     index++, 16, 19, "streets:motorway_link", sMotorwayLinkInline));
        ...
        layers.add(genLayer("streets:motorway_link:outline:l",  index++, 14, 15, "streets:motorway_link", sMotorwayLinkOutlineL));
        ...
        layers.add(genLayer("streets:motorway_link:outline:xl", index++,  0, 13, "streets:motorway_link", sMotorwayLinkOutlineXL));

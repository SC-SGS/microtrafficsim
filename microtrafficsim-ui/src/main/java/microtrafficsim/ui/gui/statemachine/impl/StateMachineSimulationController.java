...
import microtrafficsim.ui.gui.statemachine.GUIState;
 ...
 */
public class StateMachineSimulationController implements GUIController {

    private static Logger logger = new EasyMarkableLogger(StateMachineSimulationController.class);
    ...
    public StateMachineSimulationController(ScenarioConstructor scenarioConstructor, MapViewer mapviewer) {
        this(scenarioConstructor, mapviewer, "MicroTrafficSim - GUI Example");
    }

    public StateMachineSimulationController(ScenarioConstructor scenarioConstructor, MapViewer mapviewer, String title) {
        super();
    ...
    */
    /**
     * This interface gives the opportunity to call the constructor of {@link StateMachineSimulationController} with a parameter,
